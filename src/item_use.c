...
static const u8 sText_PlayedPokeFluteCatchy[] = _("You played the Poké Flute.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayedPokeFlute[] = _("You played the Poké Flute.");
