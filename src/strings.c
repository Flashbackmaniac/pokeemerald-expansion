...
const u8 gText_Pokedex[] = _("Pokémon"); // Unused
...
const u8 gText_PlayedPokeFluteCatchy[] = _("You played the Poké Flute.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("You played the Poké Flute.");
...
const u8 gEasyChatGroupName_Endings[] = _("Eendings");
